<?php
class Common_MerchantController extends Common_BaseController {
    public function postDispatch() {
		//マーチャント以外はそれぞれの権限のモジュールへ転送
		if($this->view->user->kind != 4){
		...
		}elseif($this->view->controller == "sougi" && $this->view->action == "report"){
			$option = array(
				"layout" => "nohtml",
				"layoutPath" => APPLICATION_PATH . "/layouts/scripts/"
			);
