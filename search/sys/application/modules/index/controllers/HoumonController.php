<?php
//コンポーネントのロード
class HoumonController extends Common_IndexController {
	public $_setting;
	public $_db;
	private $_orign;
	//初期化メソッドの定義
	...
	public function listAction() {
		...
		//ユーザーリストの読み込み
			...
			//検索クエリを作成
			$whereArr = array("i.kind=3","i.houmon=1");
			//検索キーワードが指定された場合
			if(!empty($keyword)){
